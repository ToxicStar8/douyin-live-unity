...
namespace Framework
{
    ...
    public class SocketRoutine
    {
        ...
        {
            GameGod.Instance.Log(E_Log.Proto, "WebSocket 发送消息", bytes.ToString());
        ...
        private void DispatchMsg(SocketEvent evt)
        {
            ...
            if (payloadPackage.NeedAck)
            {
                ...
                GameGod.Instance.EventManager.SendEven((ushort)GameData.UIEvent.OnReadMsg, new Message() { Method = "发送ack心跳" });
            }
            //4、消息解析输出
